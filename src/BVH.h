// This file was part of Eigen, a lightweight C++ template library
// for linear algebra.
//
// Copyright (C) 2021 Ante Qu <antequ@cs.stanford.edu>
// Copyright (C) 2009 Ilya Baran <ibaran@mit.edu>
// Originally named "BVH" by Ilya Baran.
// The version in Eigen's codebase is located at
// https://gitlab.com/libeigen/eigen/-/blob/master/unsupported/Eigen/BVH/.
//
...
/**
  ...
  *
  * To be used in the algorithms, a hierarchy must implement the following traversal mechanism (see ModifiedKdBVH for a sample implementation): \code
